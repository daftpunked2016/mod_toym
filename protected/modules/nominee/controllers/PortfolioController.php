...
class PortfolioController extends Controller
{
	...
	{	
		...
		if((!empty($_POST)) || (!empty($_FILES))) {
			...
			if(isset($_FILES['supporting_photo_1'])) $portfolio->uploadEachFileToAttr($_FILES['supporting_photo_1'], 'supporting_photo_1', null, $nominee_id);
			if(isset($_FILES['supporting_photo_2'])) $portfolio->uploadEachFileToAttr($_FILES['supporting_photo_2'], 'supporting_photo_2', null, $nominee_id);
			if(isset($_FILES['supporting_photo_3'])) $portfolio->uploadEachFileToAttr($_FILES['supporting_photo_3'], 'supporting_photo_3', null, $nominee_id);
			if(isset($_FILES['supporting_photo_4'])) $portfolio->uploadEachFileToAttr($_FILES['supporting_photo_4'], 'supporting_photo_4', null, $nominee_id);
	...
	public function actionSubmit()
	{
    	...
    	$nominee_essays = ToymNomineeEssays::model()->find("nominee_id = {$nominee_id}");
