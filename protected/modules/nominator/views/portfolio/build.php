    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="pull-right">
          ...
          <?php else: ?>
            <a href="<?= Yii::app()->createUrl('nominator/portfolio/build?page=1'); ?>" class="btn btn-default btn-lg btn-flat"> <strong>1</strong> </a>
          <?php endif; ?>

          <?php if($page == 2): ?>
            <button type="button" class="btn btn-primary btn-lg btn-flat" disabled> <strong>2</strong> </button>
          <?php else: ?>
            <a href="<?= Yii::app()->createUrl('nominator/portfolio/build?page=2'); ?>" class="btn btn-default btn-lg btn-flat"> <strong>2</strong> </a>
          <?php endif; ?>
          ...
          <?php else: ?>
            <a href="<?= Yii::app()->createUrl('nominator/portfolio/build?page=3'); ?>" class="btn btn-default btn-lg btn-flat"> <strong>3</strong> </a>
          <?php endif; ?>
        </div>
      </div>
    </div>
...
<script>
  $(document).ready(function() {
    ...
    $(document).on('click', '#btn-save', function() {
      ...
      $.ajax({
           url: site_url + '/nominator/portfolio/save',
           method: "POST",
           data: formData,
