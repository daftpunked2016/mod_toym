  ...
  <div class="box-body">
    ...
    <div class="form-group">
      <div class="col-md-12">
        ...
        <?php echo $form->textArea($nominee_info,'nominator_essay_1',array('class'=>'form-control nominator-essays','id'=>'nominator-essay-1', 'placeholder'=>'')); ?>
        <?php echo $form->error($nominee_info,'nominator_essay_1', array('class'=>'text-red')); ?>
      </div>
    </div>
    <div class="form-group">
      <div class="col-md-12">
        ...
        <?php echo $form->textArea($nominee_info,'nominator_essay_2',array('class'=>'form-control nominator-essays', 'id'=>'nominator-essay-2','placeholder'=>'')); ?>
        <?php echo $form->error($nominee_info,'nominator_essay_2', array('class'=>'text-red')); ?>
      </div>
    </div>
    <div class="form-group">
      <div class="col-md-12">
        ...
        <?php echo $form->textArea($nominee_info,'nominator_essay_3',array('class'=>'form-control nominator-essays', 'id'=>'nominator-essay-3', 'placeholder'=>'')); ?>
        <?php echo $form->error($nominee_info,'nominator_essay_3', array('class'=>'text-red')); ?>
      </div>
    </div>
  </div>
  <!-- /.box-body -->
